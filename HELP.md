...
* The original package name 'com.example.data-format-conversion' is invalid and this project uses 'com.example.dataformatconversion' instead.
...
* [Spring Web](https://docs.spring.io/spring-boot/docs/3.2.0-M1/reference/htmlsingle/#web)
